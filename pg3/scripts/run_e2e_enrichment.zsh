...
echo "env.EXA_API_KEY=${EXA_API_KEY:+(set)}" >> "$OUT_DIR/run_meta.txt"
echo "env.FIRECRAWL_API_KEY=${FIRECRAWL_API_KEY:+(set)}" >> "$OUT_DIR/run_meta.txt"
echo "env.OPENROUTER_API_KEY=${OPENROUTER_API_KEY:+(set)}" >> "$OUT_DIR/run_meta.txt"
